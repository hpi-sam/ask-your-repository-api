...
def create_args():
    ...
    return {"id": fields.UUID(required=True, location="view_args"), "id_token": fields.String(required=True)}


def update_args():
    """Defines and validates params for update"""
    return {"id": fields.UUID(required=True, location="view_args"), "auth_code": fields.String(required=True)}
